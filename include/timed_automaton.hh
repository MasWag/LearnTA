...
namespace learnta {
  ...
  struct TAState {
    ...
    /*!
     * @brief Remove transitions with weaker guards if they have the same target
     *
    ...
    /*!
     * @brief Check if there is a non-deterministic branching due to different set of imprecise clocks
     */
    [[nodiscard]] bool needSplitting() const;

    /*!
     * @brief Make it deterministic by merging transitions.
     *
